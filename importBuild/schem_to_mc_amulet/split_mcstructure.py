...
I file risultanti saranno salvati come .schematic con suffisso _part1 e _part2 e il conteggio dei blocchi.
"""
...
def split_structure(
    ...
    try:
        ...
        logging.info(f"Il file ha {non_air_count} blocchi (> {threshold}), procedo con la divisione")
